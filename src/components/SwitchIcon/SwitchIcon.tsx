...
const SwitchIcon = () => {
    ...
    return (
        <div className={`transition-all flex ${switchPlacement} items-center border-2 border-font_primary_black w-[30px] h-[17px] rounded-[13px] p-[1px] dark:border-font_primary_white`} onClick={toggleDarkMode}>
