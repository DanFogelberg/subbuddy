...
const CategoryCard:React.FC<CategoryCardProps> = (props) => {
    return (
        <article className='py-3 px-[26px] flex justify-center items-center min-w-[116px] bg-black rounded-[5px] text-font_primary_white relative' onClick = {() => {props.setCategoryView(props.category); props.setSubscriptionsView("category")}}>
