...
const Menu = (props:MenuProps) => {
    ...
    return (
        <nav className='bg-black flex flex-row justify-between rounded-[64px] px-10 py-1 shadow-[rgba(0,_0,_0,_0.50)_0px_0px_8px_0px] text-font_primary_white text-[10px] dark:bg-button_primary_orange'>
