...
const AddSubscriptionCard: React.FC<AddSubscriptionCardProps> = (props) => {
    return (
        <article onClick = {() => {props.setSubscriptionsView("addSubscription")}}className='bg-font_primary_white text-font_primary_black rounded-[10px] shadow-[rgba(0,_0,_0,_0.25)_0px_2px_2px_0px] flex justify-between items-center py-4 px-6 w-full'>
            <div>
